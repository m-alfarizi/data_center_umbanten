                    ...
                    <div class="card-body ">
                        ...
                        <ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0" role="tablist">
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="nav-link active border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#tab_forms_widget_1">
                                    <span class="nav-icon py-3 w-auto">
                                        <i class="fa fa-user" style="font-size: 30px;"><span></span></i>
                                    </span>
                                    <span class="nav-text font-size-lg py-2 font-weight-bold text-center">
                                        <span class="menu-text">Auditor</span>
                                    </span>                                    
                                </a>
                            </li>                            
                            <!--end::Item-->
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#tab_forms_widget_1">
                                    <span class="nav-icon py-3 w-auto">
                                        <i class="fa fa-user-circle" style="font-size: 30px;"><span></span></i>
                                    </span>
                                    <span class="nav-text font-size-lg py-2 font-weight-bold text-center">
                                        <span class="menu-text">Atasan Langsung</span>
                                    </span>                                    
                                </a>
                            </li>                            
                            <!--end::Item-->
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#tab_forms_widget_1">
                                    <span class="nav-icon py-3 w-auto">
                                        <i class="fa fa-user-plus" style="font-size: 30px;"><span></span></i>
                                    </span>
                                    <span class="nav-text font-size-lg py-2 font-weight-bold text-center">
                                        <span class="menu-text">Pejabat Pengusul AK</span>
                                    </span>                                    
                                </a>
                            </li>                            
                            <!--end::Item-->
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#tab_forms_widget_1">
                                    <span class="nav-icon py-3 w-auto">
                                        <i class="fa fa-user-secret" style="font-size: 30px;"><span></span></i>
                                    </span>
                                    <span class="nav-text font-size-lg py-2 font-weight-bold text-center">
                                        <span class="menu-text">Pejabat Berwenang AK</span>
                                    </span>                                    
                                </a>
                            </li>                            
                            <!--end::Item-->
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#tab_forms_widget_1">
                                    <span class="nav-icon py-3 w-auto">
                                        <i class="fa fa-user-times" style="font-size: 30px;"><span></span></i>
                                    </span>
                                    <span class="nav-text font-size-lg py-2 font-weight-bold text-center">
                                        <span class="menu-text">Sekretaris Penilai</span>
                                    </span>                                    
                                </a>
                            </li>                            
                            <!--end::Item-->
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#tab_forms_widget_1">
                                    <span class="nav-icon py-3 w-auto">
                                        <i class="fa fa-users" style="font-size: 30px;"><span></span></i>
                                    </span>
                                    <span class="nav-text font-size-lg py-2 font-weight-bold text-center">
                                        <span class="menu-text">Tim Penilai</span>
                                    </span>                                    
                                </a>
                            </li>                            
                            <!--end::Item-->                            
