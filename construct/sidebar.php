            ...
            <div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto " id="kt_brand">
                    ...
                    <a href="index.php">
                        ...
                        <!--end::Svg Icon--></span><span class="menu-text">Data Center</span></a>
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4 " data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                        ...
                        <ul class="menu-nav ">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a href="d_prodi.php" class="menu-link menu-toggle"><i class="fa fa-file menu-icon"><span></span></i><span class="menu-text">Data Program Studi</span></a>
                            </li>
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a href="d_matakuliah.php" class="menu-link menu-toggle"><i class="fa fa-book menu-icon"><span></span></i><span class="menu-text">Data Mata Kuliah</span></a>
                            </li>
