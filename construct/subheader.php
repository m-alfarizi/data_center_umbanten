            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu" class="header-menu header-menu-mobile  header-menu-layout-default ">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <!--begin::logo-h-->
                        <div class="logo-h logo-h-40 mr-5">
                            <span class="logo-h-label">
                                <img src="assets/media/logos/logo_umbanten.png" class="h-75" alt="">
                            </span>
                        </div>
                        <!--end::logo-h-->
                        <!--begin::Text-->
            ...
            <div class="topbar">
                ...
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                        ...
                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Logout</span>
        ...
        <div class="subheader subheader-solid " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <span class="text-dark font-weight-bold mt-2 mb-2 mr-5 font-size-sm">
                        Nama Pegawai
                        <br><span class="mb-0 d-block text-muted font-size-sm">1234567890 12345678</span>
                    </span>
                    <!--end::Page Title-->
                    <!--begin::Action-->
                    <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                    <span class="text-muted font-size-sm mr-4">Inspektorat II</span>
                    <!--a href="#" class="btn btn-light-primary font-weight-bolder btn-sm">Profil</a-->
                    <!--end::Action-->
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
