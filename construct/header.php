...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Manajemen File Dosen | Universitas Muhammadiyah Banten</title>
    <meta name="description" content="itjen, Auditor, JFK, SKP, Dupak, Angka Kredit, ESDM, Inspektorat" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable">	
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.php">
            <!--img alt="Logo" src="assets/media/logos/logo-light.png" /--> EDUPAK
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
